...
public class LevelPanel : MonoBehaviour
{
    ...
    [SerializeField] private Transform selectionIconParent
        ;
    ...
    public IEnumerator InitCouroutine(Action callback)
    {
        ...
        {
            LevelItem newLevel = Instantiate(prefab, container).GetComponent<LevelItem>();
            ...
            GameObject icon = Instantiate(selectionIcon, selectionIconParent);
            yield return null;
